...
- (void)generateIntroPageViews {
    [self.onboardContentArray enumerateObjectsUsingBlock:^(NSDictionary *pageDict, NSUInteger idx, BOOL *stop) {
        ...
        pageView.titlelabel.textColor = [UIColor blackColor];
...
-(UIButton *)lastPageButton {
    if (!_lastPageButton) {
        ...
        _lastPageButton.backgroundColor = [UIColor colorWithRed:238.f/255.f green:0.f/255.f blue:51.f/255.f alpha:1.f];
